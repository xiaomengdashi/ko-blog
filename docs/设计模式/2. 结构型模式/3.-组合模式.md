...
![](/img/posts/9fb5859fbbeda69735dcd9b5bd270d0e.jpeg)

对于`草帽大船团`的结构组成，很像一棵树：路飞是这棵树的根节点，旗下的七个船长是路飞的子节点。在这七个船长的旗下可能还有若干个船长。。。

![](/img/posts/cdd324956ff4eb23edf3a1198858ed47.png)
...
![](/img/posts/07a0546bace58f87d4d5056fbd943cef.png)
