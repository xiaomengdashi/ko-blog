---
sidebar_position: 4
slug: /C++/面试题/春招面经米哈游C-服务端开发-上-问题也太多了吧-网友-看到这么多已经汗流浃背了-
---
...
前几天有小伙伴在留言区说想看米哈游的面经：

![](/img/posts/f80594e23bfc5257e68bd0c68410e284.png)

今天，它来了~

我不仅整理了米哈游的面经，还为这位小伙伴送去了一本书，以表示他对我的支持！

当然，不定期送书，大家都会有机会~

马上四月中旬了，已经有offer的小伙伴还在努力去拿更好的。

没offer的小伙伴，也不要气馁，机会都是留给有准备的人的！你只管努力，剩下的交给天意！

我陪大家一起all in春招！！！

今天要分享的是位大佬面试米哈游整理的面经，光是一面，内容就超乎想象的多！

内容非常多，这篇先分享一半，关注我，明天继续！

来源：

https://www.nowcoder.com/feed/main/detail/7f28c235a0134b4a9be9fea52efe9551
...
##### 3.0.1. 为什么禁止复制？
###### 3.0.1.1. 独占所有权的语义
unique_ptr 的核心理念是“独占”，如果允许复制：

+ 多个 unique_ptr 会指向同一块内存。
+ 当这些指针销毁时，会多次调用 delete，导致未定义行为（如双重释放）。

###### 3.0.1.2. shared_ptr 的对比
shared_ptr支持复制，通过引用计数管理多个拥有者。

unique_ptr不使用计数，追求轻量和明确性，因此禁用复制。

### 4. 4、我一个类实例化不想被复制 怎么办？**
...
##### 5.0.2. 对象本身线程不安全
如果多个线程同时修改同一个 shared_ptr 对象（如赋值sp=new_sp），会导致数据竞争。
...
+ 这些计数器存储在控制块中，与管理的对象分开。

原子操作：

控制块中中的计数器使用原子操作（如std::atomic或底层CAS）实现。
...
+ 合并代码段、数据段。
+ 处理静态库（如libstdc++.a）或动态库（如 libstdc++.so）。
...
### 9. 9、动态库静态库区别？怎么链接？**
##### 9.0.1. 静态库
静态库是一组目标文件（.o或.obj）的集合，通常以.a（Linux）或 .lib（Windows）为扩展名，在链接时将代码嵌入到最终的可执行文件中。
...
C++ 支持：C++20引入`std::counting_semaphore`。
...
前面也总结了超100篇面经，可以直接访问专栏：

《[面经专栏](https://mp.weixin.qq.com/mp/appmsgalbum?__biz=MzU5MTgxNzI5Nw==&action=getalbum&album_id=3104351725295288321&scene=173&subscene=&sessionid=svr_f62a4cf6b3a&enterid=1743181880&from_msgid=2247492118&from_itemidx=1&count=3&nolastread=1&scene=21#wechat_redirect)》

或者

Github：https://github.com/aqjsp

也放在了码云上，国内网可以顺利访问学习：

Gitee：https://gitee.com/aqjsp

发现有问题的知识点大家直接留言就行了，欢迎大家指正哦~

最后，我再跟大家说明一件事儿：

**「以后不再维护免费技术群！」**

其实大家能刷到我（菜鸟），也会刷到过其他大佬，他们都会有自己的学习交流群。

我今天为什么会说我不再免费维护呢？

1. 之前有几个免费群，也有近千人，大家都在里面唠嗑干啥，无可厚非。可以说除了技术，什么都交流，我觉得这违背了我建群的初衷。
2. 个人精力有限，新群会有其他大厂大佬一起维护，技术范围更广！
3. 在轻松的氛围学习技术，学起来更高效。

最后一个免费群，大家可以先进：广告党请绕道
...
[【春招面经】快手音视频C++一面，面试官虽然有点严肃，不过还是给过了！！](https://mp.weixin.qq.com/s?__biz=MzU5MTgxNzI5Nw==&mid=2247492166&idx=1&sn=a0c287912e6c082f7d35ce39626e6fef&scene=21#wechat_redirect)

[【春招面经】腾讯QQ--C++一面面经，虽然有些问题没回答好，但是算法题还是挽回了些分数，顺利二面！！！](https://mp.weixin.qq.com/s?__biz=MzU5MTgxNzI5Nw==&mid=2247492118&idx=1&sn=3a649c7d2a2fbd8902b4e4b2a55cd785&scene=21#wechat_redirect)

[【春招面经】腾讯地图C++一面凉经，只背了八股没准备好项目，面试结束秒挂。。。](https://mp.weixin.qq.com/s?__biz=MzU5MTgxNzI5Nw==&mid=2247492089&idx=1&sn=e97cdf4bfe9eb56fa4cbc729b0036960&scene=21#wechat_redirect)

[【春招面经】腾讯二面，三个半小时。。。腾讯都这么顶嘛？？](https://mp.weixin.qq.com/s?__biz=MzU5MTgxNzI5Nw==&mid=2247492068&idx=1&sn=c795f1bbace48205b49b9d5ec476363b&scene=21#wechat_redirect)

[【春招面经】字节C++系统工程师二面，面试官真大佬，不问到我答不上就继续深问。。。](https://mp.weixin.qq.com/s?__biz=MzU5MTgxNzI5Nw==&mid=2247492042&idx=1&sn=a643f14e9ffcfaf7f1a76efed4b7b181&scene=21#wechat_redirect)



> 来自: [【春招面经】米哈游C++服务端开发（上），问题也太多了吧！网友：看到这么多已经汗流浃背了。。。](https://mp.weixin.qq.com/s/z6tifLfmzlZ0pOhM9ABMyQ)
>
