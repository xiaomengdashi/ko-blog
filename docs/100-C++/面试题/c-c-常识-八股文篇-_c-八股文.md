...
###### 3. 3、[字符串](https://so.csdn.net/so/search?q=%E5%AD%97%E7%AC%A6%E4%B8%B2&spm=1001.2101.3001.7020)操作函数
+ 字符串初始化函数 memset
...
###### 4. 4、[static](https://so.csdn.net/so/search?q=static&spm=1001.2101.3001.7020)的用法（定义和用途）（必考）
...
###### 7. 7、const常量和#define的区别（编译阶段、安全性、内存占用等）
...
###### 8. 8、变量的作用域（[全局变量](https://so.csdn.net/so/search?q=%E5%85%A8%E5%B1%80%E5%8F%98%E9%87%8F&spm=1001.2101.3001.7020)和局部变量）
...
###### 10. 10、经典的sizeof(struct)和sizeof(union)内存对齐
+ **内存对齐作用**： 
...
###### 12. 12、内存四区，什么变量分别存储在什么区域，堆上还是栈上。
![](/img/posts/a904d4c981668ec8443996b2e1ee918a.png)
...
###### 13. 13、使用32位编译情况下，给出判断所使用机器大小端的方法。
![](/img/posts/aaca0aa20bd1dd3db6f12be513cdca5c.png)![](/img/posts/81c871c9282fc01e192a2b9f2673bfd7.png)
...
###### 15. 15、与或非，异或。运算符优先级
![](/img/posts/0c24061f15565f748535a9192ac6f167.png)
