...
![](/img/posts/86f287405ee9dce304a9dbb3435fb7f2.jpeg)
...
#### 1.2. 内联函数是什么，是不是只要声明为内联函数就一定会在原地展开
...
##### 1.21.4. unique_ptr与shared_ptr的区别是什么？
...
##### 1.22.3. auto类型推导
##### 1.22.4. 右值引用
#### 1.23. static_cast和dynamic_cast的区别
...
#### 1.49. 44、C++里的转移语义有了解嘛？涉及到右值引用；&&意思是什么？
