...
#### 5.1.3. Promise对象（promise_type类）访问
```cpp
...
#### 6.3.2. `await_transform(Awaitable&& awaitable)`
```cpp
...
### 7.2. 标准库提供的awaitable对象
#### 7.2.1. `std::suspend_always`
```cpp
