...
slug: /C++/基础知识/告别SFINAE-C-20-Concepts模板元编程进阶指南-WEBKT
### 1. 告别SFINAE？C++20 Concepts模板元编程进阶指南！
...
##### 1.2.1. SFINAE的常见用法
##### 1.2.2. SFINAE的缺点
#### 1.3. C++20 Concepts：模板的类型约束
##### 1.3.1. Concept 的定义
##### 1.3.2. Concept 的使用
##### 1.3.3. requires 子句
#### 1.4. Concepts vs. SFINAE：一场美丽的邂逅
##### 1.4.1. 示例：使用 Concepts 改进 SFINAE 代码
#### 1.5. Concepts 的局限性
#### 1.6. 结论：拥抱 Concepts，展望未来
#### 1.7. 前言：模板元编程的演进之路
