---
sidebar_position: 7
slug: /Linux网络编程/TCP之-流量控制-滑动窗口-和-拥塞控制-拥塞控制的工作过程-
---
...
![](/img/posts/3bc65bc5940e4aef359a74b4e6d5d511.png)
...
`**3.发送端如何知道已经丢包？**`  
![](/img/posts/d8bc3d64a8404b353149664c802a5723.png)  
`**4.为什么会有拥塞控制？**`
...
`**6.拥塞控制的工作过程**`  
`**初始化阶段**`  
![](/img/posts/86fb18c1ae3cd70f7da6688f069f0d9a.png)  
`**慢开始阶段**`  
阶段（一）  
![](/img/posts/a1b07d86da6cd11c17a9cfc0fdf44372.png)  
阶段（二）  
![](/img/posts/95bc6b948346984db27673406e7fcb24.png)  
阶段（三）  
![](/img/posts/a2e93ba4612745140e88df83a1e10eb1.png)  
阶段（四）  
![](/img/posts/53b877c4a778472685977ef0ccde6f8c.png)  
`**拥塞避免阶段**`  
![](/img/posts/7c410c534c7c2a98930df2449a3fed01.png)  
`**拥塞调整阶段**`  
阶段（一）  
![](/img/posts/f654aa2cdbcc54968403875f61cf0f80.png)  
阶段（二）  
![](/img/posts/d79ca13daeaa34fe1dd6cce34acd41b3.png)  
阶段（三）  
![](/img/posts/8ec34ab4b83dcd9d4cb682466f0d357f.png)
...
![](/img/posts/e694a1b04d513778be80873509b73201.png)

觉得自己有收获的小伙伴，可以打赏一下博主哦，让小姐姐去买个零食，哈哈哈哈  
![](/img/posts/93b307fb9e697e74d94653c4ff139160.png)
